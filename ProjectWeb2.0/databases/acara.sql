...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 30 Nov 2019 pada 16.37
...
(15, './../assets/events/seminarFoods.jpg', 'Pengumpulan KKM', 'Bagi para mahasiswa yang belum melakukan pemutihan KKM, harap mengumpulkan pada bususi/L-202. Demikian pengumuman ini harap diperhatikan.', '', '', '', 0, '2', '13');
...
--
ALTER TABLE `acara`
  MODIFY `id_acara` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
COMMIT;
