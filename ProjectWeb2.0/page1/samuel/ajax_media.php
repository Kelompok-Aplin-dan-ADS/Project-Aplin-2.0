...
<?php  
	if ($_POST['mode'] == "media") {
		...
		if ($t1 == "1") {	
			...
			$query3 = mysqli_query($conn ,"SELECT acara.id_acara, acara.gambar, acara.judul , acara.deskripsi , acara.kategori , acara.jurusan FROM acara WHERE kategori ='$t1'");

			echo "<div class='row'>";
				echo "<div class='col-md-12'>";		
					echo "<div class='col-md-6' style='border:1px solid black;'>";							
			while ($row = mysqli_fetch_array($query1)) {								
						echo "<div id='foto'><img src='".$row['gambar']."' class='card-img-top h-100' alt='error'></div>";	
