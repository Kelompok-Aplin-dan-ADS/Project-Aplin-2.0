...
<div id="fab-footer">
  ...
  <div class="container text-center text-md-left mt-5">
    ...
    <div class="row mt-4">
      <!-- Grid column -->
      <div class="col-md-4 col-lg-4 col-xl-4 mx-auto mb-6" style="margin-left:0px;">
        <div style="width:400px;">
            <!-- Links -->
            <h6 class="text-uppercase font-weight-bold" >STUDENT SERVICE</h6>
            <hr class="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style="width: 100px;">
            <p>
            <a href="#!">Sistem Informasi Mahasiswa (SIM)</a>
            </p>
            <p>
            <a href="#!">National Library(PNRI)</a>
            </p>
            <p>
            <a href="#!">Library</a>
            </p>
      ...
      <!-- Grid column -->
      <div class="col-md-5 col-lg-4 col-xl-4 mx-auto mb-6">
        <div style="width:400px;">
        <!-- Links -->
  ...
  <!-- Copyright -->
  <div class="footer-copyright text-center py-3" style="background-color:brown;color:white;">
    Copyright © www.istts.ac.id 2017
  </div>
  <!-- Copyright -->
